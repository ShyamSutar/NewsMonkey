  ...
  render() {
    ...
    return (
      ...
      <div className='flex justify-center m-10 h-full'>
            ...
            <button type="button" class="inline-flex relative items-end w-full">
              ...
              <div class="inline-flex absolute -top-2 -right-3 justify-center items-center p-2 w-fit h-8 text-xs font-bold text-white bg-red-500 rounded-full border-2 border-white dark:border-gray-900"><a href={newsUrl}>{source}</a></div>
            </button>
